    ...
    <>
      <section>
        <div className="container banner">
          ...
          <div className="content">
            <div style={{color: 'white', fontWeight: 900, fontSize: '4rem'}}>Privacy Policy - BhagavadGita.io</div>
            <p>Last updated: 2023-07-17</p>
          </div>
        </div>
      </section>
      <div className="container">
        ...
        <ul>
          ...
          <li>Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Ved Vyas Foundation, C-604 IRWO Sector 47 Gurugram Gurgaon HR 122018 INDIA.</li>
          ...
          <li>Country refers to: Haryana, India</li>
          ...
          <li>Website refers to BhagavadGita.io, accessible from https://bhagavadgita.io</li>
